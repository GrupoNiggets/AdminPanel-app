  ...
  const saveBug = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        console.log("Bug guardado exitosamente:", data);
        onSave(data.data || data);
        onClose();
      } else {
        const errorData = await res.json().catch(() => ({}));
        console.error("Error al guardar el bug:", res.status, errorData);
        console.error(
          "Detalles del error:",
        ...
        const errorMsg =
          ...
          res.statusText;
        alert(`Error al guardar el bug: ${errorMsg}`);
      }
    } catch (err) {
      console.error("Error al guardar el bug:", err);
    ...
    <div className="modal-overlay">
      <div className="modal">
        ...
        <div className="modal-footer">
          ...
          <button className="btn-save" onClick={saveBug}>
            Guardar
          </button>
        </div>
      </div>
